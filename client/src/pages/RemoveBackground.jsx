    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1'>
            ...
            <div>
              ...
              >
                ...
                <div className='text-center'>
                  <div className={`p-3 bg-gray-100 rounded-full inline-block mb-3 transition-all duration-300 ${dragOver ? 'scale-110 bg-orange-100' : ''}`}>
                    <Upload className={`w-6 h-6 transition-colors ${dragOver ? 'text-orange-500' : 'text-gray-400'}`} />
                  </div>
          ...
          <button 
            ...
            className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F6AB41] to-[#FF4938] text-white px-4 py-3 mt-6 text-sm rounded-lg cursor-pointer shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed group'
          >
            {loading ? (
              ...
              <>
                <Eraser className='w-5 group-hover:rotate-12 transition-transform duration-200'/>
                Remove background
              </>
            )}
          </button>
        ...
        <div className='flex items-center justify-between mb-4'>
          ...
          {content && (
            <button
              ...
              className='p-2 bg-orange-100 hover:bg-orange-200 rounded-lg transition-colors group'
